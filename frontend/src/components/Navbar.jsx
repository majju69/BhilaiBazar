...
const Navbar = () => {
    ...
    const {cart,checkCartSizeIsZero}=useCartStore();
            ...
            <div className='container mx-auto px-4 py-3'>
                ...
                <div className='flex flex-wrap justify-between items-center'>
                    ...
                    <Link to='/' className='text-2xl font-bold text-emerald-400 items-center space-x-2 flex'>
                        {/* Change to E-Commerce if needed */}
                        BhilaiBazar
                    </Link>
                    ...
                    <nav className='flex flex-wrap items-center gap-4'>
                        ...
                        {user&&(
                            <Link to={"/cart"} className='relative group text-gray-300 hover:text-emerald-400 transition duration-300 ease-in-out'>
                                ...
                                {!checkCartSizeIsZero()&&<span className='absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-2 py-0.5  text-xs group-hover:bg-emerald-400 transition duration-300 ease-in-out'>
                                    {cart.length}
                                </span>}
                            </Link>
                        )}
