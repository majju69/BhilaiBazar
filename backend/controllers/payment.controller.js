...
export const createCheckoutSession=async (req,res)=>        // untested 2:45:25
{
    try
    {
...
export const checkoutSuccess=async(req,res)=>       // untested 2:55:08
{
    try
    {
    ...
    {
        console.log(`\nError in checkoutSuccess controller: ${error.message}\n`);
        res.status(500).json({message:`Internal server error ${error.message}`});
    }
}